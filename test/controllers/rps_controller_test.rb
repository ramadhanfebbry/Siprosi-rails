...
class RpsControllerTest < ActionController::TestCase
  ...
  test "should create rp" do
    assert_difference('Rp.count') do
      post :create, rp: { date: @rp.created_at.to_date, item_name: @rp.item_name, ketengaran: @rp.ketengaran, plan_date: @rp.plan_date, schedule_qty: @rp.schedule_qty, site: @rp.site }
    end
  ...
  test "should update rp" do
    patch :update, id: @rp, rp: { date: @rp.created_at.to_date, item_name: @rp.item_name, ketengaran: @rp.ketengaran, plan_date: @rp.plan_date, schedule_qty: @rp.schedule_qty, site: @rp.site }
    assert_redirected_to rp_path(assigns(:rp))
  end
